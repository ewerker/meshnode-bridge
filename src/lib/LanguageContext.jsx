  ...
  de: {
    ...
    landing: {
      ...
      topics: [
        ...
        ['Node-Entdeckung', 'Node-Daten wie last_heard, SNR, battery_level, GPS, Hardware und Uptime werden per MQTT-Polling lokal sowie global gesammelt und visualisiert. Ein Versenden an unerreichbare Partner über fremde Nodes ist optional möglich. Diese Funktionalität kann pro Nachricht eingestellt werden; optional lassen sich die Hops verändern.'],
  ...
  en: {
    ...
    landing: {
      ...
      topics: [
        ...
        ['Node discovery', 'Node data such as last_heard, SNR, battery_level, GPS, hardware, and uptime is collected and visualized locally and globally via MQTT polling. Sending to otherwise unreachable partners through external nodes is optionally possible. This functionality can be configured per message, with optional hop adjustments.'],
