  ...
  de: {
    ...
    landing: {
      ...
      topics: [
        ...
        ['ACK & Zustellstatus', 'Mit want_ack und eindeutigen client_ref-IDs verfolgt das Portal ACK, NAK und Implicit ACK über dedizierte MQTT-Topics transparent nach. Diese Funktionalität kann pro Nachricht eingestellt werden; optional lassen sich die Hops verändern.'],
        ['Node-Entdeckung', 'Node-Daten wie last_heard, SNR, battery_level, GPS, Hardware und Uptime werden per MQTT-Polling lokal sowie global gesammelt und visualisiert. Ein Versenden an unerreichbare Partner über fremde Nodes ist optional möglich.'],
  ...
  en: {
    ...
    landing: {
      ...
      topics: [
        ...
        ['ACK & delivery status', 'With want_ack and unique client_ref IDs, the portal transparently tracks ACK, NAK, and implicit ACK via dedicated MQTT topics. This functionality can be configured per message, with optional hop adjustments.'],
        ['Node discovery', 'Node data such as last_heard, SNR, battery_level, GPS, hardware, and uptime is collected and visualized locally and globally via MQTT polling. Sending to otherwise unreachable partners through external nodes is optionally possible.'],
