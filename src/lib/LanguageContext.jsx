...
export const translations = {
  de: {
    ...
    landing: {
      ...
      topics: [
        ['MQTT als Nervensystem', 'Das Portal kann Meshtastic-Geräte entfernter und unerschlossener Gebiete außerhalb der direkten Funkreichweite erreichen. Ganze Regionen lassen sich über Internetstrecken per MQTT überbrücken; entfernte Nodes — auch Nichtmitglieder — werden über „Tunnel” angebunden. Das Portal kann außerdem als virtueller Meshtastic-Node genutzt werden: Nutzer ohne eigenes Gerät erhalten Pseudo-Node-IDs wie ?1234563, die intern geroutet werden. So erreichen sich Webuser untereinander, echte Geräte und Webuser gegenseitig.'],
  ...
  en: {
    ...
    landing: {
      ...
      topics: [
        ['MQTT as the nervous system', 'The portal can reach Meshtastic devices in remote and underserved areas outside direct radio range. Whole regions can be bridged over internet links via MQTT; remote nodes — including non-members — are connected through “tunnels”. The portal can also act as a virtual Meshtastic node: users without their own device receive pseudo node IDs such as ?1234563, which are routed internally. This lets web users reach each other, real devices, and be reached by real devices.'],
