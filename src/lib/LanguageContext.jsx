...
export const translations = {
  de: {
    ...
    landing: {
      ...
      topics: [
        ['MQTT als Nervensystem', 'Das Portal kann ganze Regionen bridgen und über MQTT-Wildcard-Abonnements relevante Nachrichten aus Topics wie msh/<region>/proxy/+/+/# erfassen.'],
  ...
  en: {
    ...
    landing: {
      ...
      topics: [
        ['MQTT as the nervous system', 'The portal can bridge whole regions and capture relevant messages via MQTT wildcard subscriptions from topics such as msh/<region>/proxy/+/+/#.'],
